...
export class Migration1705818524740 implements MigrationInterface {
    name = 'Migration1705818524740'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "itinerary_participants_users" ("itineraryId" integer NOT NULL, "usersId" integer NOT NULL, CONSTRAINT "PK_b5d622382c357e03a8fbd7c5178" PRIMARY KEY ("itineraryId", "usersId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_62e211b9d48a9aeac636ae331e" ON "itinerary_participants_users" ("itineraryId") `);
        await queryRunner.query(`CREATE INDEX "IDX_cf1c398a4cb15de9ec1467e984" ON "itinerary_participants_users" ("usersId") `);
        ...
        await queryRunner.query(`ALTER TABLE "itinerary_participants_users" ADD CONSTRAINT "FK_62e211b9d48a9aeac636ae331ed" FOREIGN KEY ("itineraryId") REFERENCES "itinerary"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "itinerary_participants_users" ADD CONSTRAINT "FK_cf1c398a4cb15de9ec1467e9849" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "itinerary_participants_users" DROP CONSTRAINT "FK_cf1c398a4cb15de9ec1467e9849"`);
        await queryRunner.query(`ALTER TABLE "itinerary_participants_users" DROP CONSTRAINT "FK_62e211b9d48a9aeac636ae331ed"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cf1c398a4cb15de9ec1467e984"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_62e211b9d48a9aeac636ae331e"`);
        await queryRunner.query(`DROP TABLE "itinerary_participants_users"`);
