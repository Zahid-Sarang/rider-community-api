...
export class Migration1706435472792 implements MigrationInterface {
    name = 'Migration1706435472792'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_relationships" ("id" SERIAL NOT NULL, "followDate" TIMESTAMP NOT NULL DEFAULT now(), "lastActive" TIMESTAMP NOT NULL DEFAULT now(), "follower_id" integer, "followed_id" integer, CONSTRAINT "PK_a9f4f64c43f6ec154dd602c47d8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_relationships" ADD CONSTRAINT "FK_7b94a31b5a2363800c8254e3893" FOREIGN KEY ("follower_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_relationships" ADD CONSTRAINT "FK_00ec1e323db313122574d21dc82" FOREIGN KEY ("followed_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_relationships" DROP CONSTRAINT "FK_00ec1e323db313122574d21dc82"`);
        await queryRunner.query(`ALTER TABLE "user_relationships" DROP CONSTRAINT "FK_7b94a31b5a2363800c8254e3893"`);
